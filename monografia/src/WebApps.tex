...
É a camada responsável pela lógica de negócios da aplicação. É a camada que serve como intermediária entre a as camadas de apresentação e de persistência, processando os dados que o usuário entra e passando-os para a camada de persistência, ou lendo os dados que o usuário solicitou e exibindo-os na camada de apresentação.
