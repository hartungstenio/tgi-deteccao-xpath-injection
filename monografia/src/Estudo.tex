...
Pode-se observar que o mínimo de tratamento de erros é necessário para enganar esses scanners. Aplicações que exibem uma mensagem ``amigável'' caso algum erro ocorra não foram detectados pelo Arachni e pelo w3af. Já o WebCruiser foi capaz de detectar algumas dessas aplicações.
