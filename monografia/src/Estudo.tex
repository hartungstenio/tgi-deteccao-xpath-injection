...
Três \estrangeiro{scanners} de vulnerabilidade foram selecionados nessa pré avaliação: Arachni, w3af e webCruiser. Os demais \estrangeiro{scanners} tiveram que ser eliminados por apresentarem os seguintes problemas:
\begin{enumerate*}
...
As seções a seguir descrevem os \estrangeiro{scanners} selecionados.
...
A maior parte das vulnerabilidades (duas pelo Arachni e o w3af e 3 pelo WebCruiser) foi encontrada na aplicação 2 e as demais na aplicação 1. Apenas o w3af foi capaz de analisar os serviços que utilizavam SOAP (aplicação 4), mas nenhuma das vulnerabilidades nesses serviços foi detectada.