...
\begin{figure}[h]
 \centering
 \includegraphics[width=7cm]{img/ExemploXPath}%
 \caption{Documento XML de exemplo para consultas}%
 \label{fig:ExemploXPath}%
\end{figure}
...
\begin{figure}[h]
 \centering
 \includegraphics[width=13cm]{img/ExemploCSharp}%
 \caption{Código C\# executando uma consulta XPath}%
 \label{fig:ExemploCSharp}%
\end{figure}
...
\subsection{Evitando Xpath Injection}
